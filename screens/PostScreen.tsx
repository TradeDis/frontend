...
export default function PostScreen({ navigation, route }) {
  ...
  const createConversation = () => {
    ...
    axios
      .post(`http://172.20.10.7:3000/api/v1/conversations`, payload)
      .then(resp => {
        ...
        axios
          .post(`http://172.20.10.7:3000/api/v1/conversations/${conversation_id}/messages`, system)
          .then(resp => {
            const firstMessage = {
              conversation_id: conversation_id,
              user: {
            ...
            axios
              .post(`http://172.20.10.7:3000/api/v1/conversations/${conversation_id}/messages`, firstMessage)
              .then(resp => {
                // resp.data.map(data => {
